...
if info_list:
    df = pd.DataFrame(info_list, columns=[
        'N° OM', 'Descrição OM', 'Centro de Custo', 'Criticidade', 'Local de Instalação', 'Descrição do Local de Instalação', 'Local de Instalação Superior', 'Descrição do Local de Instalação Superior', 'Data Inicio', 'Data Final'])

...
# Function to extract the "N° OM:", "DESCRIÇÃO OM:", "Centro de Custo", "Criticidade", "Local de Instalação", and "Descrição do Local de Instalação" from the text
...
# Initialize list to collect "N° OM", "DESCRIÇÃO OM", "Centro de Custo", "Criticidade", "Local de Instalação", "Descrição do Local de Instalação", "Data Inicio" and "Data Final" information
info_list = []
...
if info_list:
    df = pd.DataFrame(info_list, columns=[
        'N° OM', 'Descrição OM', 'Centro de Custo', 'Criticidade', 'Local de Instalação', 'Descrição do Local de Instalação', 'Data Inicio', 'Data Final'])

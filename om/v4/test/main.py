...
#     8: ['(h)'],
#     9: ['Prioridade'],
#     10: ['Tipo de Manutenção'],
#     11: ['Tipo de Atividade'],
#     12: ['Ponto de Partida'],
#     13: ['Comprimento'],
#     14: ['Plano de Manutenção'],
#     15: ['Descrição do Plano'],
#     16: ['Ponto Final'],
#     17: ['Unidade de Medida'],
#     18: ['Condição de Operação'],
#     19: ['Equipe'],
#     20: ['Responsável'],
#     21: ['Planejador'],
#     22: ['03/06/2024'],
...
#     26: ['0.000'],
#     27: ['Média'],
#     28: ['Serviço de Suporte'],
#     29: ['Suporte'],
#     30: ['Parada Desenergizada'],
#     31: ['EX065'],
#     32: ['RIP ELETRICA/INSTRU -'],
#     33: ['Líder de Terceiros / Vendor Leader 030'],
#     34: ['SLB ROT USINA EL'],
#     35: ['Status Sistema Ordem'],
#     36: ['Status Usuário Ordem'],
#     37: ['LIB CAPC CCOP SCDM'],
#     38: ['EXEC VPTS']
# }

# df = pd.DataFrame.from_dict(data, orient='index', columns=['Valor'])

# # Dicionário com o mapeamento de colunas para linhas
# columns_mapping = {
#     "Data Inicio": 22,
#     "Hora Início": 23,
#     "Data Fim": 24,
...
#     "Duração": 26,
#     "Prioridade": 27,
#     "Tipo de Manutenção": 28,
#     "Tipo de Atividade": 29,
#     "Ponto de Partida": 30,
#     "Comprimento": 31,
#     "Plano de Manutenção": 32,
#     "Descrição do Plano": 33,
#     "Condição de Operação": 34,
#     "Status Usuário Ordem": 36,
#     "Equipe": 35,
#     "Responsável": 37,
#     "Planejador": 38
# }
...
# new_data = {col: df.iloc[columns_mapping[col]]['Valor']
#             for col in columns_mapping}
# new_df = pd.DataFrame([new_data])

# # Exportando para Excel
# new_df.to_excel('ordem_de_manutencao.xlsx', index=False)

# print("DataFrame exportado com sucesso para 'ordem_de_manutencao.xlsx'")
